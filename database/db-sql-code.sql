...
ALTER TYPE public.account_type OWNER TO cse340mn;
...
-- Task 6: Update all records in the inventory table to add "/vehicles" to the middle of the file path
...
-- Creates or ensures the existence of a 'message' table in the 'public' schema to store messages.
